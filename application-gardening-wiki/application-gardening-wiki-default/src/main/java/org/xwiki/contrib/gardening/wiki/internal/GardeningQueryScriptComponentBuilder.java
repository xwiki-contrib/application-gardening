...
/**
 * Allow to register dynamically {@link DefaultGardeningQueryScript} against the component manager using wiki
 * components.
 *
 * @version $Id$
 * @since 1.0
 */
@Component
@Named(GardeningQueryScriptComponentBuilder.BOUNDED_XOBJECT_CLASS)
@Singleton
public class GardeningQueryScriptComponentBuilder implements WikiBaseObjectComponentBuilder
{
    /**
     * The XClass that should be used to build components.
     */
    public static final String BOUNDED_XOBJECT_CLASS = "Gardening.Code.GardeningQueryScriptClass";
    ...
    {
        return new LocalDocumentReference(Arrays.asList("Gardening", "Code"), "GardeningQueryScriptClass");
    }
