...
/**
 * Define the GardeningQueryScriptClass XClass.
 *
 * @version $Id$
 * @since 1.0
 */
@Component
@Named("Gardening.Code.GardeningQueryScriptClass")
@Singleton
public class GardeningQueryScriptClassDocumentInitializer extends AbstractMandatoryClassInitializer
{
    /**
     ...
     * Default constructor.
     */
    public GardeningQueryScriptClassDocumentInitializer()
    {
        super(new LocalDocumentReference(SPACE_PATH, "GardeningQueryScriptClass"));
    }
